...
<div class="row" style="padding-top: 40px;">
    ...
    <div class="rightcolumn">
        <div class="card  text-center" >
            <h2>About User</h2>
            <div style="height:100px;"><img src="" height="100px;" width="100px;" class="img-circle" alt="Please Select your avatar"></div>
            <p>jishan</h4> is working here since <h4>2024</h4></p>
        </div>
        <div class="card text-center">
            <h2>Owners Info</h2>
            <p>Some text..</p>
