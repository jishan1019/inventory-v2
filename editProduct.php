                            ...
                            <form method="POST" action="editProduct.php">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-input pt-10">
                                        <input type="text" class="login-input" name="pname"
                                            value="<?php echo $res['name']; ?>" placeholder="Product Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6 form-input pt-10">
                                        <input type="text" class="login-input" name="buy"
                                            value="<?php echo $res['bought']; ?>" placeholder="Buy Quantity">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6 form-input pt-10">
                                        <input type="text" class="login-input" name="sell"
                                            value="<?php echo $res['sold']; ?>" placeholder="Sell Quantity">
                                    </div>
                                </div>
